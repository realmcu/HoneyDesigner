...
export const COMPONENT_SUPPORTED_EVENTS: Record<string, EventType[]> = {
  ...
  hg_qbcode: ['onClick', 'onLongPress', 'onKeyShortPress', 'onKeyLongPress', 'onMessage'],
};
...
const ANIMATION_LABEL_KEYS: Record<string, string> = {
  ...
  'SWITCH_OUT_ANIMATION_ZOOM': 'Out: Zoom',
  'SWITCH_OUT_ANIMATION_MOVE_TO_RIGHT': 'Out: Move To Right',
  'SWITCH_OUT_ANIMATION_MOVE_TO_LEFT': 'Out: Move To Left',
  'SWITCH_OUT_ANIMATION_ZOOM_TO_TOP_LEFT': 'Out: Zoom To Top Left',
  'SWITCH_OUT_ANIMATION_ZOOM_TO_TOP_RIGHT': 'Out: Zoom To Top Right',
  // 进入动画方向性选项（中文用"从"而非"向"）
  'SWITCH_IN_FROM_LEFT_USE_TRANSLATION': 'In: Slide Left',
  'SWITCH_IN_FROM_RIGHT_USE_TRANSLATION': 'In: Slide Right',
  'SWITCH_IN_FROM_TOP_USE_TRANSLATION': 'In: Slide Up',
  'SWITCH_IN_FROM_BOTTOM_USE_TRANSLATION': 'In: Slide Down',
  'SWITCH_IN_FROM_LEFT_USE_CUBE': 'In: Cube Left',
  'SWITCH_IN_FROM_RIGHT_USE_CUBE': 'In: Cube Right',
  'SWITCH_IN_FROM_TOP_USE_CUBE': 'In: Cube Up',
  'SWITCH_IN_FROM_BOTTOM_USE_CUBE': 'In: Cube Down',
  'SWITCH_IN_FROM_LEFT_USE_ROTATE': 'In: Rotate Left',
  'SWITCH_IN_FROM_RIGHT_USE_ROTATE': 'In: Rotate Right',
  'SWITCH_IN_FROM_TOP_USE_ROTATE': 'In: Rotate Up',
  'SWITCH_IN_FROM_BOTTOM_USE_ROTATE': 'In: Rotate Down',
  'SWITCH_IN_FROM_LEFT_USE_REDUCTION': 'In: Reduce Left',
  'SWITCH_IN_FROM_RIGHT_USE_REDUCTION': 'In: Reduce Right',
  'SWITCH_IN_FROM_TOP_USE_REDUCTION': 'In: Reduce Up',
  'SWITCH_IN_FROM_BOTTOM_USE_REDUCTION': 'In: Reduce Down',
  'SWITCH_IN_STILL_USE_BLUR': 'In: Blur (Still)',
};
...
export const SWITCH_OUT_STYLES = [
  ...
  { value: 'SWITCH_OUT_ANIMATION_ZOOM', labelKey: 'Out: Zoom' },
  { value: 'SWITCH_OUT_ANIMATION_MOVE_TO_RIGHT', labelKey: 'Out: Move To Right' },
  { value: 'SWITCH_OUT_ANIMATION_MOVE_TO_LEFT', labelKey: 'Out: Move To Left' },
  { value: 'SWITCH_OUT_ANIMATION_ZOOM_TO_TOP_LEFT', labelKey: 'Out: Zoom To Top Left' },
  { value: 'SWITCH_OUT_ANIMATION_ZOOM_TO_TOP_RIGHT', labelKey: 'Out: Zoom To Top Right' },
];

export const SWITCH_IN_STYLES = [
  { value: 'SWITCH_INIT_STATE', labelKey: 'No Animation (Initial)' },
  { value: 'SWITCH_IN_FROM_LEFT_USE_TRANSLATION', labelKey: 'In: Slide Left' },
  { value: 'SWITCH_IN_FROM_RIGHT_USE_TRANSLATION', labelKey: 'In: Slide Right' },
  { value: 'SWITCH_IN_FROM_TOP_USE_TRANSLATION', labelKey: 'In: Slide Up' },
  { value: 'SWITCH_IN_FROM_BOTTOM_USE_TRANSLATION', labelKey: 'In: Slide Down' },
  { value: 'SWITCH_IN_FROM_LEFT_USE_CUBE', labelKey: 'In: Cube Left' },
  { value: 'SWITCH_IN_FROM_RIGHT_USE_CUBE', labelKey: 'In: Cube Right' },
  { value: 'SWITCH_IN_FROM_TOP_USE_CUBE', labelKey: 'In: Cube Up' },
  { value: 'SWITCH_IN_FROM_BOTTOM_USE_CUBE', labelKey: 'In: Cube Down' },
  { value: 'SWITCH_IN_FROM_LEFT_USE_ROTATE', labelKey: 'In: Rotate Left' },
  { value: 'SWITCH_IN_FROM_RIGHT_USE_ROTATE', labelKey: 'In: Rotate Right' },
  { value: 'SWITCH_IN_FROM_TOP_USE_ROTATE', labelKey: 'In: Rotate Up' },
  { value: 'SWITCH_IN_FROM_BOTTOM_USE_ROTATE', labelKey: 'In: Rotate Down' },
  { value: 'SWITCH_IN_FROM_LEFT_USE_REDUCTION', labelKey: 'In: Reduce Left' },
  { value: 'SWITCH_IN_FROM_RIGHT_USE_REDUCTION', labelKey: 'In: Reduce Right' },
  { value: 'SWITCH_IN_FROM_TOP_USE_REDUCTION', labelKey: 'In: Reduce Up' },
  { value: 'SWITCH_IN_FROM_BOTTOM_USE_REDUCTION', labelKey: 'In: Reduce Down' },
  { value: 'SWITCH_IN_STILL_USE_BLUR', labelKey: 'In: Blur (Still)' },
