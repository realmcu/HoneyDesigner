...
const zhCN = {
  ...
  'Delete Locale': '删除该语言',
  'Delete locale confirm': '确定删除语言「{0}」？该语言下的所有翻译文本都会被移除，其它语言和 Key 绑定不受影响。',
  'I18n Manager': '多语言管理',
  ...
  'Delete I18n Key': '删除此多语言 Key',
  'Delete i18n key confirm': '确定删除多语言 Key「{0}」？当前没有组件引用它。',
  'Delete i18n key confirm with refs': '多语言 Key「{0}」被 {1} 个组件引用。删除后这些组件将被解绑。',
  'Delete i18n key fallback hint': '删除后这些组件将显示默认语言文本：「{0}」',
  'Delete i18n key fallback hint empty': '删除后这些组件没有默认语言文本，将回退显示组件名称。',
  'New I18n Key': '新建 Key',
  'Create I18n Key': '新建多语言 Key',
  'I18n Key Name': 'Key 名称',
  'Default Text (optional)': '默认文本（可选）',
  'Create': '创建',
  'I18n key name required': '请填写 Key 名称',
  'Invalid i18n key': '只允许字母、数字及 . _ - 符号',
  'I18n key already exists': 'Key「{0}」已存在',
  'Pick an existing i18n key': '选择已有多语言 Key',
