...
const zhCN = {
  ...
  'Localized Key': '多语言 Key',
  'Localized Key Hint': '将此标签绑定到稳定的项目字符串 key。',
  'Default Locale Text': '默认语言文本',
  'Current Locale Text': '当前语言文本',
  'Fallback Text (codegen)': 'Fallback 文本（代码生成）',
  'Fallback Text Hint': '由默认语言文本同步，用作固件代码生成 fallback。',
  'Set a localized key before editing translations': '请先设置多语言 Key 再编辑翻译',
  'Localized key does not exist yet': '多语言 Key 尚不存在',
