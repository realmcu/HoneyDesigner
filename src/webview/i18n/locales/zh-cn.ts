...
const zhCN = {
  ...
  'Delete i18n key confirm': '确定删除多语言 Key「{0}」？此操作仅从 strings.json 移除该 key 的翻译，不会改动引用它的组件。',
  'Delete i18n key confirm with refs': '多语言 Key「{0}」仍被 {1} 个组件引用。确定删除？删除后这些组件将显示「key 不存在」警告，组件上的 key 绑定会保留。',
