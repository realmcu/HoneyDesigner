...
const en = {
  ...
  'Unused I18n Key': 'Unused I18n Key',
  ...
  'Status': 'Status',
  'Search i18n': 'Search keys, text, files, components',
  'i18n.filter.all': 'All',
  ...
  'Localized Key': 'Localized Key',
  'Localized Key Hint': 'Bind this label to a stable project string key.',
  'Default Locale Text': 'Default Locale Text',
  'Current Locale Text': 'Current Locale Text',
  ...
  'Set a localized key before editing translations': 'Set a localized key before editing translations',
  'Localized key does not exist yet': 'Localized key does not exist yet',
