...
const en = {
  ...
  'New folder tooltip category': 'Switch to "All" category to create a folder',
  'Enter new folder name': 'Enter new folder name (letters, digits, underscore, dot and hyphen only; no spaces)',
  'Invalid folder name': 'Invalid folder name: letters, digits, underscore, dot and hyphen only; no spaces',
  'Folder already exists': 'Folder already exists: {0}',
  'Folder created': 'Folder created: {0}',
  ...
  'The two options are mutually exclusive, only the selected one takes effect.': 'The two options are mutually exclusive, only the selected one takes effect.',
