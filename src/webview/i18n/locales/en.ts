...
const en = {
  ...
  'Delete i18n key confirm': 'Delete i18n key "{0}"? This only removes the key from strings.json and does not modify components referencing it.',
  'Delete i18n key confirm with refs': 'I18n key "{0}" is still referenced by {1} component(s). Delete anyway? Those components will show a "key not found" warning; their key binding is kept.',
